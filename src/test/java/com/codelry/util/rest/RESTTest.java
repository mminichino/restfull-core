...
public class RESTTest {
  ...
  public void testRest1() {
    REST client = new REST(hostname, useSsl).enableDebug(enableDebug).addHeader("x-api-key", token);
    ...
    try {
      ...
      LOGGER.error("testRest1: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest2() {
    ...
    try {
      ...
      LOGGER.error("testRest2: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest3() {
    ...
    try {
      ...
      LOGGER.error("testRest3: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest4() {
    ...
    try {
      ...
      LOGGER.error("testRest4: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
    Assertions.fail();
  }
  ...
  public void testRest5() {
    ...
    try {
      ...
      LOGGER.error("testRest5: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest6() {
    ...
    try {
      ...
      LOGGER.error("testRest6: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest7() {
    ...
    try {
      ...
      LOGGER.error("testRest7: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest8() {
    ...
    try {
      ...
      LOGGER.error("testRest8: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest9() {
    ...
    try {
      ...
      LOGGER.error("testRest9: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest10() {
    ...
    try {
      ...
      LOGGER.error("testRest10: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest11() {
    ...
    try {
      ...
      LOGGER.error("testRest11: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest12() {
    ...
    try {
      ...
      LOGGER.error("testRest12: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
    Assertions.fail();
  }
  ...
  public void testRest13() {
    ...
    try {
      ...
      LOGGER.error("testRest13: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
  ...
  public void testRest14() {
    ...
    try {
      ...
      LOGGER.error("testRest14: code: {}: message: {}", client.responseCode, new String(client.responseBody, Charset.defaultCharset()));
      Assertions.fail();
    }
  }
}
